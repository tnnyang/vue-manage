...
<style scoped>
.login{background:url(../assets/images/loginBg.jpg) no-repeat center top / 1920px 1080px;height:1080px;overflow:hidden;}
.login h2{font-size:35px;color:#062f41;margin:400px 0 32px;}
